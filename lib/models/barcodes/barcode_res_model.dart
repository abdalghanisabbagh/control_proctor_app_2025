...
class BarcodeResModel {
  ...
  BarcodeResModel.fromJson(json) {
    ...
    studentSeatNumberResModel = json['student_seat_numnbers'] != null
        ? StudentSeatNumberResModel.fromJson(json['student_seat_numnbers'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (studentSeatNumberResModel != null) {
      data['student_seat_numnbers'] = studentSeatNumberResModel!.toJson();
    }
    return data;
  }
}
